...
class GameObject {
  ...
  constructor(gameObjectItem) {
    this.createdAt = gameObjectItem.createdAt;
    this.dimensions = gameObjectItem.dimensions;
  }
